...
realm_hash = md5.new(args.username + ":" + realm + ":" + args.password).hexdigest().upper()
random_hash = md5.new(args.username + ":" + random + ":" + realm_hash).hexdigest().upper()
sofia_result = sofia_hash(args.password)
final_hash = md5.new(args.username + ":" + random + ":" + sofia_result).hexdigest().upper()
...
firmware = ("\xa2\x00\x00\x00\x00\x00\x00\x00" +
